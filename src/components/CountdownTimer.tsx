...
const CountdownTimer = ({ 
  ...
  return (
    <div className="bg-gradient-to-r from-red-500 to-red-600 text-white p-6 rounded-lg shadow-lg border-2 border-red-400 animate-[pulse_8s_cubic-bezier(0.4,0,0.6,1)_infinite]">
