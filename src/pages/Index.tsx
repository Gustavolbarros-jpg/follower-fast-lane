...
// Definindo a interface para o tipo de um plano
interface Plan {
  name: string;
  followers: number;
...
const Index: React.FC = () => {
  ...
  const handleUsernameChange = (planIndex: number, value: string): void => {
    setUsernames((prev) => ({
      ...prev,
      [planIndex]: value,
    }));
  ...
  // ATENÇÃO: Verifique se estes links de checkout são os corretos e válidos da sua conta Cakto.
  const plans: Plan[] = [
    {
      ...
      popular: false,
      badge: null,
      checkoutLink: "https://pay.cakto.com.br/39j3r5j_471102",
    },
    {
      name: "Pacote Amador",
      followers: 2500,
      ...
      popular: false,
      badge: null,
      checkoutLink: "https://pay.cakto.com.br/39nx9jr_474721",
    },
    {
      ...
      popular: true,
      badge: "MAIS VENDIDO",
      checkoutLink: "https://pay.cakto.com.br/ysjjsww_474722",
    },
    {
      ...
      popular: false,
      badge: null,
      checkoutLink: "https://pay.cakto.com.br/6ozb4xt_474724",
    },
    {
      name: "Pacote VIP",
      followers: 20000,
      ...
      popular: false,
      badge: null,
      checkoutLink: "https://pay.cakto.com.br/7ddzkg3_474726",
    },
    {
      name: "Pacote Premium",
      followers: 50000,
      ...
      popular: false,
      badge: null,
      checkoutLink: "https://pay.cakto.com.br/dfuhu7t_474727",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {plans.map((plan, index) => {
              const cleanUsername = (usernames[index] || "")
                .replace(/@/g, "")
                .trim();

              const finalCheckoutLink =
                cleanUsername.length > 2
                  ? `${plan.checkoutLink}?name=${cleanUsername}`
                  : "#";

              const handleLinkClick = (
                e: React.MouseEvent<HTMLAnchorElement>
              ) => {
                if (finalCheckoutLink === "#") {
                  e.preventDefault();
                  alert(
                    "Por favor, digite um @usuário válido com pelo menos 3 caracteres."
                  );
                }
              };
                ...
                >
                  ...
                  <CardHeader className="text-center pb-2">
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div className="text-green-600">
                        + {plan.bonusFollowers.toLocaleString()} Seguidores
                        Bônus
                      </div>
                      <div className="text-blue-600">
                        +{plan.bonusEngagement.toLocaleString()} Bônus
                        Engajamento
                      </div>
                    </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      />
                      <a href={finalCheckoutLink} onClick={handleLinkClick}>
                        <Button
